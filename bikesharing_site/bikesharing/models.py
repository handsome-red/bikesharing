...
def translit_to_eng(s: str) -> str: # функция костыль для перевода русских букв в латинские
...
class Bike(models.Model):
    ...
    is_published = models.BooleanField(choices=tuple(map(lambda x: (bool(x[0]), x[1]), Status.choices)), default=Status.PUBLISHED, verbose_name='Заголовок')
...
#    def save(self, *args, **kwargs): # метод для автоматического формирования поля slug
